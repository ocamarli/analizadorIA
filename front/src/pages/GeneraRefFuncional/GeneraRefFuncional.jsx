...
const GeneraRefFuncional = () => {
  ...
  const generateDef = async () => {
    ...
    try {
      ...
      const apiResponse = await fetch(`${API_BASE_URL}/api/api/generar-def-requerimientos`, {
        method: 'POST',
        body: formData,
      });
...
export default GeneraRefFuncional;