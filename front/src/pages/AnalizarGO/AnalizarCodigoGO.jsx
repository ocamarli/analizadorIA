...
const API_BASE_URL = process.env.API_BASE_URL || 'http://127.0.0.1:5000';
    try {
      const response = await axios.post(`${API_BASE_URL}/api/analizarCodigoGO`, {
    ...
    <Container maxWidth="lg" sx={styles.container}>
      ...
      <Box sx={styles.header}>
        ...
        <Box>
          ...
          <Typography variant="subtitle1" color="text.secondary">
            Genera información de código go utilizando IA
          </Typography>
        </Box>
      </Box>
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 4 }}>
        ...
        <Box component="form" onSubmit={handleSubmit} sx={styles.inputSection}>
          ...
          >
            {loading ? 'Analizando código...' : 'Analizar'}
          </Button>
        </Box>
      </Paper>
...
export default AnalizarCodigoGO;